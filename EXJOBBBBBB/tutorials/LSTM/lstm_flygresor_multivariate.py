...
def workingexample():
    ...
    plt.plot(range(len(ytrain)),ytrain,'-x', label="training data ytrain")
    ...
    plt.plot(
        ...
        ytest,'-x', label="testing data ytest")
        
    #plotting testing prediction testPredict
    testPredictFlatten = testPredict.flatten()
    plt.plot(range(len(ytrain),len(testPredictFlatten)+len(ytrain)),testPredictFlatten,'-x', label="test prediction")
